...
# LPIPS (very slow → compute occasionally)
...
print("✅ Model loaded from Drive and ready for inference!")
...
print(f"✅ Resuming from epoch {start_epoch}") # Removed val_loss from print statement
